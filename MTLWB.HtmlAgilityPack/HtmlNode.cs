...
namespace MTLWB.HtmlAgilityPack
{
	/// <summary>
	...
	public class HtmlNode: IXPathNavigable
	{
		...
		static HtmlNode()
		{
            ...
            ElementsFlags.Add("userInputLocalizable", HtmlElementFlag.CData);
            ElementsFlags.Add("title", HtmlElementFlag.CData);
            ElementsFlags.Add("codeInline", HtmlElementFlag.CData);
            ElementsFlags.Add("languageKeyword", HtmlElementFlag.CData);
            //ElementsFlags.Add("procedure", HtmlElementFlag.CData);
            //ElementsFlags.Add("step", HtmlElementFlag.CData);
            //ElementsFlags.Add("content", HtmlElementFlag.CData);
            //ElementsFlags.Add("codeEntityReference", HtmlElementFlag.CData);
            //ElementsFlags.Add("alert", HtmlElementFlag.CData);
            //ElementsFlags.Add("code", HtmlElementFlag.CData);
            ElementsFlags.Add("uri", HtmlElementFlag.CData);
            //ElementsFlags.Add("buildInstructions", HtmlElementFlag.CData);
            //ElementsFlags.Add("comments", HtmlElementFlag.CData);
            //ElementsFlags.Add("codeExample", HtmlElementFlag.CData);
            //ElementsFlags.Add("description", HtmlElementFlag.CData);
            //ElementsFlags.Add("listItem", HtmlElementFlag.CData);
            //ElementsFlags.Add("relatedTopics", HtmlElementFlag.CData);
            //ElementsFlags.Add("link", HtmlElementFlag.CData);
            ElementsFlags.Add("para", HtmlElementFlag.CData);
		...
		public static bool IsClosedElement(string name)
		{
            ...
            object flag = ElementsFlags[name];
			if (flag == null)
			{
				return false;
			}
		...
		/// <param name="isConfigTag"></param>
		/// <returns></returns>
		public HtmlNodeCollection SelectNodes(string xpath,bool isConfigTag)
		{
